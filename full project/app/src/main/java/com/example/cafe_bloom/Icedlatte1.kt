...
class Icedlatte1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.icedlatte)
        ...
        btnMedium.setOnClickListener {
            selectSize(btnMedium, btnSmall, btnLarge, 1600, tvTotalPrice)
            updateSelectedItems(tvSelectedItems)
        }
    ...
    private fun updateSelectedItems(tvSelectedItems: TextView) {
        ...
        selectedItems.append("Size: ${if (sizePrice == 1500) "Small" else if (sizePrice == 1600) "Medium" else "Large"}\n")
