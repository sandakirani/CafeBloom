...
class Iconicchocolate1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnLarge.setOnClickListener {
            selectSize(btnLarge, btnSmall, btnMedium, 1750, tvTotalPrice)
            updateSelectedItems(tvSelectedItems)
        }
    ...
    private fun updateSelectedItems(tvSelectedItems: TextView) {
        ...
        selectedItems.append("Size: ${if (sizePrice == 1500) "Small" else if (sizePrice == 1650) "Medium" else "Large"}\n")
