...
class Lemonmintcoke1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.lemonmintcoke)
    ...
    private fun updateSelectedItems(tvSelectedItems: TextView) {
        ...
        selectedItems.append("Size: ${if (sizePrice == 1300) "Small" else if (sizePrice == 1500) "Medium" else "Large"}\n")
