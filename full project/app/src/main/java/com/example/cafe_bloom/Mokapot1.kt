...
class Mokapot1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.mokapot)
        ...
        btnMedium.setOnClickListener {
            selectSize(btnMedium, btnSmall, btnLarge, 1750, tvTotalPrice)
            updateSelectedItems(tvSelectedItems)
        }
        btnLarge.setOnClickListener {
            selectSize(btnLarge, btnSmall, btnMedium, 1800, tvTotalPrice)
            updateSelectedItems(tvSelectedItems)
        }
    ...
    private fun updateSelectedItems(tvSelectedItems: TextView) {
        ...
        selectedItems.append("Size: ${if (sizePrice == 1700) "Small" else if (sizePrice == 1750) "Medium" else "Large"}\n")
