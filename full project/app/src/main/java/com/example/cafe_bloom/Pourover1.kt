...
class Pourover1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.pourover)
        ...
        btnMedium.setOnClickListener {
            selectSize(btnMedium, btnSmall, btnLarge, 2300, tvTotalPrice)
            updateSelectedItems(tvSelectedItems)
        }
    ...
    private fun updateSelectedItems(tvSelectedItems: TextView) {
        ...
        selectedItems.append("Size: ${if (sizePrice == 2200) "Small" else if (sizePrice == 2300) "Medium" else "Large"}\n")
